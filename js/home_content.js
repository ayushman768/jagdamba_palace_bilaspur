...
var my_Content = function() {
    ...
    var myContent = [{
		...
		image04: 'images/party_hall_in_jagdamba_palace_bilaspur_chhattishgarh (1).jpg',
		image05: 'images/party_hall_in_jagdamba_palace_bilaspur_chhattishgarh (2).jpg',
		image06: 'images/party_hall_in_jagdamba_palace_bilaspur_chhattishgarh (3).jpg',
	      ...
	      <div class="row">
		      <div class="col-md-12">
			      <div class="my_video text-center">
				     <a href="restaurent.html" class="my_btn_1">More Rooms</a>
				  </div>
			  </div>
		  </div>
	  </div>
